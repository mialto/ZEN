...
if($_POST){
    ...
    if($numfilas>0){
        while($fila = $resultado->fetch_array()) {
            ...
            $subject =  "Recupera tu clave en Espaal Food";
            $cuerpoMail = "<p>Si has recibido este mail es por que lo has solicitado para regenerar tu contraseña de espaalfood.es<p>";
