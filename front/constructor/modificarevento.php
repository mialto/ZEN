    ...
    if($_POST){
        ...
        if($_POST['ceremonia']=="Ceremonia"){
            ...
            if (isset($_FILES['musicaConyuge1']) && $_FILES['musicaConyuge1']['error'] === UPLOAD_ERR_OK) {
                ...
                $archivoConyuge1 = $ceremonia['archivo_entrada_conyuge1'];
            }
            if (isset($_FILES['musicaConyuge2']) && $_FILES['musicaConyuge2']['error'] === UPLOAD_ERR_OK) {
                ...
                $archivoConyuge2 = $ceremonia['archivo_entrada_conyuge2'];
            }
            if (isset($_FILES['musicaSalida']) && $_FILES['musicaSalida']['error'] === UPLOAD_ERR_OK) {
                ...
                $archivoSalida = $ceremonia['archivo_salida_ceremonia'];
            }
            if (isset($_FILES['musicaAdicional']) && $_FILES['musicaAdicional']['error'] === UPLOAD_ERR_OK) {
                ...
                $archivoInformacionAdicional = $ceremonia['archivo_informacion_adicional'];
            }
            //los campos de texto
            ...
            modificarCeremonia($id, $lugarCeremonia, $entradaConyuge1, $archivoConyuge1, $entradaConyuge2, $archivoConyuge2, $salidaCeremonia, $archivoSalida, $informacionAdicional, $archivoInformacionAdicional);
        }else{
            modificarCeremonia($id, "", "", "", "", "", "", "", "", "");
        }
        //fin de ceremonia
        ...
        if($_POST['coctel']=="Cóctel"){
            ...
            if (isset($_FILES['musica_momento_coctel']) && $_FILES['musica_momento_coctel']['error'] === UPLOAD_ERR_OK) {
                ...
                $musicaMomentoCoctel = $coctel['archivo_momento'];
            }
            modificarCoctel($id, $momento, $listasMusica, $musicaMomentoCoctel);
        }else{
            modificarCoctel($id, "", "", "");
        }
        ...
        if($_POST['banquete']=="Banquete"){
            ...
            if (isset($_FILES['musica_momento_banquete']) && $_FILES['musica_momento_banquete']['error'] === UPLOAD_ERR_OK) {
                ...
                $musicaMomentoBanquete = $banquete['archivo_momento'];
            }
            modificarBanquete($id, $momento, $listasMusica, $musicaMomentoBanquete);
        }else{
            modificarBanquete($id, "", "", "");
        }
        //fin de banquete
        ...
        if($_POST['barra']=="Barra libre"){
            ...
            if($baile=='Con baile'){
                ...
                if (isset($_FILES['musica_baile_nupcial']) && $_FILES['musica_baile_nupcial']['error'] === UPLOAD_ERR_OK) {
                    ...
                    $musica_baile_nupcial = $barra['archivo_baile_nupcial'];
                }
            }
            ...
            if($tengo_logo_boda == 'Sí'){
                if (isset($_FILES['mi_logo_de_boda']) && $_FILES['mi_logo_de_boda']['error'] === UPLOAD_ERR_OK) {
                    ...
                    $archivo_logo_boda=$barra['archivo_logotipo'];
                }
            }else{
                $archivo_logo_boda='';
            }
            ...
            if(isset($_POST['directrices_logo']) && !empty($_POST['directrices_logo'])) {
                ...
                $directrices_logo = nl2br($directrices_logo);
            }
            ...
            modificarBarra($id, $baile, $nombre_baile, $musica_baile_nupcial, $imprescindibles, $no_suenen, $djanima, $tipo_musica, $edad_media, $preferencias_musicales, $djadicional, $logo_boda,
